                ...
                .'<div class="row" style="margin-bottom: 10px">'
                    ...
                    .'<div class="col-sm-6">'
                        .'<div class="input-group input-group-sm width-warning">'
                            .'<div class="input-group-prepend"><label class="input-group-addon input-group-text" for="dataWidth-'. $unique .'">'.Yii::t('cropper', 'Width').' ('. $cropWidth .'px)</label></div>'
                            .'<input type="text" class="form-control" id="dataWidth-'. $unique .'" placeholder="width"><div class="input-group-append"><span class="input-group-addon input-group-text">px</span></div>'
                        .'</div>'
                    .'</div>'
                    .'<div class="col-sm-6">'
                        .'<div class="input-group input-group-sm height-warning">'
                            .'<div class="input-group-prepend"><label class="input-group-addon input-group-text" for="dataHeight-'. $unique .'">'.Yii::t('cropper', 'Height') .' ('. $cropHeight .'px)</label></div>'
                            .'<input type="text" class="form-control" id="dataHeight-'. $unique .'" placeholder="height"><div class="input-group-append"><span class="input-group-addon input-group-text">px</span></div>'
                        .'</div>'
                    .'</div>'
                .'</div>'
                .'<div class="row" style="margin-bottom: 10px">'
                    .'<div class="col-sm-6">'
                        .'<div class="input-group input-group-sm">'
                            .'<div class="input-group-prepend"><label class="input-group-addon input-group-text" for="dataX-'. $unique .'">X</label></div>'
                            .'<input type="text" class="form-control" id="dataX-'. $unique .'" placeholder="x"><div class="input-group-append"><span class="input-group-addon input-group-text">px</span></div>'
                        .'</div>'
                    .'</div>'
                    .'<div class="col-sm-6">'
                        .'<div class="input-group input-group-sm">'
                            .'<div class="input-group-prepend"><label class="input-group-addon input-group-text" for="dataY-'. $unique .'">Y</label></div>'
                            .'<input type="text" class="form-control" id="dataY-'. $unique .'" placeholder="y"><div class="input-group-append"><span class="input-group-addon input-group-text">px</span></div>'
                           .'</div>'
                    .'</div>'
                .'</div>'
                .'<div class="pull-left">'
